package com.xiaosi.flutterbluetooth.reader.helper;
...
import com.xiaosi.flutterbluetooth.reader.base.CMD;
import com.xiaosi.flutterbluetooth.reader.base.ERROR;
import com.xiaosi.flutterbluetooth.reader.base.HEAD;
import com.xiaosi.flutterbluetooth.reader.base.MessageTran;
import com.xiaosi.flutterbluetooth.reader.base.ReaderBase;
import com.xiaosi.flutterbluetooth.reader.base.StringTool;
...
public class ReaderHelper {
    ...
    public final static String BROADCAST_REC_DATA = "com.reader.helper.RECData";
    /**
     ...
     * @param curReaderSetting Current reader parameter
     */
...
//        if (mReader == null) {
            ...
            mReader = new ReaderBase(in, out) {
                ...
                public void reciveData(byte[] btAryReceiveData) {
                    ...
                    itent = new Intent(BROADCAST_REC_DATA);
                    itent.putExtra("type", ERROR.SUCCESS & 0xFF);
                    itent.putExtra("log", strLog);
                    mLocalBroadcastManager.sendBroadcast(itent);
						/*length = 0;
