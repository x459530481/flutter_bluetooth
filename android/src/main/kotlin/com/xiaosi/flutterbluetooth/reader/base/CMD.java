	...
	public static String format(byte btCmd)
    {
        ...
        switch (btCmd)
        {
            ...
            case SET_UART_BAUDRATE:
            	strCmd = "set_uart_baudrate";
                break;
            case GET_FIRMWARE_VERSION:
                strCmd = "get_firmware_version";
                break;
            case SET_READER_ADDRESS:
                strCmd = "set_reader_add";
                break;
            ...
            case SET_OUTPUT_POWER:
                strCmd = "set_output_power";
                break;
            case GET_OUTPUT_POWER:
                strCmd = "get_output_power";
                break;
            ...
            case SET_BEEPER_MODE:
                strCmd = "set_beeper_mode";
                break;
            case GET_READER_TEMPERATURE:
                strCmd = "get_rader_temp";
                break;
            case READ_GPIO_VALUE:
                strCmd = "read_gpio_value";
                break;
            case WRITE_GPIO_VALUE:
                strCmd = "write_gpio_value";
                break;
            ...
            case SET_TEMPORARY_OUTPUT_POWER:
                strCmd = "set_temp_output_power";
                break;
            case SET_READER_IDENTIFIER:
                strCmd = "set_reader_identi";
                break;
            case GET_READER_IDENTIFIER:
                strCmd = "get_reader_identi";
                break;
            case SET_RF_LINK_PROFILE:
                strCmd = "set_rf_link_pro";
                break;
            case GET_RF_LINK_PROFILE:
                strCmd = "get_rf_link_pro";
                break;
            ...
            case ISO18000_6B_WRITE_TAG:
                strCmd = "iso_b_write_tag";
                break;
            case ISO18000_6B_LOCK_TAG:
                strCmd = "iso_b_lock_tag";
                break;
            case ISO18000_6B_QUERY_LOCK_TAG:
                strCmd = "iso_b_query_lock_tag";
                break;
            case GET_INVENTORY_BUFFER:
                strCmd = "get_inventory_buff";
                break;
            case GET_AND_RESET_INVENTORY_BUFFER:
                strCmd = "get_ant_reset_inv";
                break;
            case GET_INVENTORY_BUFFER_TAG_COUNT:
                strCmd = "get_inventory_buffer_tag_count";
                break;
            case RESET_INVENTORY_BUFFER:
                strCmd = "reset_inventory_buff";
                break;
            default:
            	strCmd = "unknown_operate";
                break;
        }
        return strCmd;
    }
